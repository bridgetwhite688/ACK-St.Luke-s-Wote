                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                      ...
                      <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                          ...
                          <li><a class="dropdown-item" href="history.html">School History</a></li>
                    ...
                    <div class="col-sm-6">
                      ...
                      <p>ACK St. Luke’s Wote Township is a premier institution renowned
                        ...
                        lab, agriculture farms, and high-speed internet connectivity. These
                         facilities ensure that our students receive a comprehensive and contemporary education.</p>
                    </div>
                </div>
              </div> <br>
             ...
             <div id="newsAndUpdates">
              ...
              <div id="theNews" class="row">
                ...
                <div id="" class="col-sm-12">
                  ...
                  <img src="../public/ack/images1/intake advert.jpg" id="intakeImage" class="img-fluid" alt="">
...
<div id="textCarousel" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
      <div class="carousel-item active">
          <div><h3 id="testimonialsHeader">Pauline Musyimi.-Alumni</h3>
          <p id="testimonialsBody">It was a nice place where I got molded,  didn't regret.</p>
        </div>
      </div>
      <div class="carousel-item">
          <div><h3 id="testimonialsHeader">Charles Mutua-Alumni</h3>
          <p id="testimonialsBody"> It's simply awesome! The best public boarding primary school within the country.</p></div>
      </div>
      <div class="carousel-item">
          <div>
        ...
        <div id="firstFooter">
          <div id="footer1" class="row">
            <div id="ImportantLinks" class="col-sm-4">
              ...
              <a id="anchorTag" href="sponsor.html">Sponsor</a> <br>
